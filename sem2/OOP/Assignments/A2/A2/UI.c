...
void generate_10_entries(Service* s) {
    add_product(s, "Milk", "Diary", 3, 20, 4, 2025,1);
    add_product(s, "Cheese", "Diary", 5, 23, 4, 2025,1);
    add_product(s, "Chocolate", "Snack", 2, 19, 5, 2025,1);
    add_product(s, "Apple", "Fruit", 10, 15, 5, 2025,1);
    add_product(s, "Banana", "Fruit", 3, 10, 4, 2025,1);
    add_product(s, "Steak", "Meat", 1, 22, 3, 2025,1);
    add_product(s, "Sausage", "Meat", 7, 24, 3, 2025,1);
    add_product(s, "Egg", "Poultry", 13, 19, 5, 2025,1);
    add_product(s, "Zucchini", "Vegetable", 2, 19, 3, 2025,1);
    add_product(s, "Cake", "Snack", 1, 18, 3, 2025,1);
}
...
void handle_add(Service* s) {
    ...
    while (loop) {
        ...
        add_product(s, name, cat, q, d, m, y,1);
        break;
    }
...
void handle_update(Service* s) {
    ...
    Date date;
    setDate(&date, d, m, y);
    int r = update_product(s, name, cat, new_name, new_cat, q, &date,1);
}
